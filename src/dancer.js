var makeDancer = function (top, left, timeBetweenSteps, URL, name) {
  this.$node;
  this.assignNode(URL, name);
  this.step();
...
makeDancer.prototype.assignNode = function (URL, name) {
  this.$node = $(`<span class="${name} dancer"><img class="dancerImg" src = ${URL}></span>`)
}
